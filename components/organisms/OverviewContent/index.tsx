                    ...
                    <div className="main-content main-content-table overflow-auto">
                        <table className="table table-borderless">
                            ...
                            <tbody>
                                ...
                                <TableRow image="overview-3" title="Clash of clans" category="Desktop" item={100} price={120000} status="Failed"/>
                                <TableRow image="overview-4" title="The Royal Game" category="Desktop" item={225} price={200000} status="Success"/>
                            </tbody>
                        </table>
                    </div>
                </div>
